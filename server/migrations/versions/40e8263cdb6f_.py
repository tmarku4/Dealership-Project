...
Revision ID: 40e8263cdb6f
Revises: 
Create Date: 2023-12-20 18:06:08.649022
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['car_id'], ['cars_table.id'], name=op.f('fk_car_images_table_car_id_cars_table')),
    sa.PrimaryKeyConstraint('id')
    )
